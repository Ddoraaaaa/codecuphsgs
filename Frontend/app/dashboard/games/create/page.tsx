        ...
        <div className="space-y-12">
            <div className="border-b border-gray-900/10 pb-12">
                ...
                <div className="sm:col-span-3">
                    ...
                    <div className="mt-2">
                        <input type="text" onChange={onNameUpdate}  className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-black sm:text-sm sm:leading-6">
                        </input>
                    </div>
                </div>
                <div className="sm:col-span-3">
                    ...
                    <div className="mt-2">
                        <input type="text" onChange={onStatementURLUpdate}
                         className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-black sm:text-sm sm:leading-6"></input>
                    </div>
                </div>
                ...
                <div className="sm:col-span-3">
                    ...
                    <div className="mt-2">
                        <input type="text" onChange={onRenderURLUpdate} className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-black sm:text-sm sm:leading-6"></input>
                    </div>
                </div>
            </div>
        </div>
